...
if ($_REQUEST['action'] == "insert") {
	...
	//if($back == "ces0000") {header("Location: http://www.clearingcentral.net");}
	//die($strSql);
...
<table width="80%" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:0px">
	<tr bgcolor="#FFFFFF">
		<td><form method="post" action="register.php">
				<table border="0" cellspacing="0" align="center" cellpadding="4">
					<tr bgcolor="#3F3F3F">
						<td colspan="2" align="center" bgcolor="#3F3F3F" class="textboldWhite">Exchange details</td>
					</tr>
					<tr bgcolor="#EEEEEE">
						<td align="right">Network ID (NID):</td>
						<td><b><?php echo $nid;?></b></td>
					</tr>
					<tr bgcolor="#DDDDDD">
						<td align="right">Server ID (SID):</td>
						<td><input type="text" name="server_id" id="server_id" value="CES0004"></td>
					</tr>
					<tr bgcolor="#DDDDDD">
						<td align="right">Server IP Address:</td>
						<td><input type="text" name="server_ip" id="server_ip" value="94.23.234.92"></td>
					<tr bgcolor="#EEEEEE">
					...
					<tr bgcolor="#EEEEEE">
						...
						<td><select name="system" id="system">
								...
								<option selected>IntegralCES</option>
...
?>
					...
					<tr bgcolor="#EEEEEE">
						...
						<td><input type="text" name="concurrency_name" id="concurrency_name" value="Euro"></td>
					</tr>
					<tr bgcolor="#EEEEEE">
						<td align="right">(plural):</td>
						<td><input type="text" name="concurrency_name_p" id="concurrency_name_p" value="Euros"></td>
					</tr>
					<tr bgcolor="#DDDDDD">
					...
					<tr bgcolor="#EEEEEE">
						...
						<td><input type="text" name="data_url" id="data_url" size="36" value="http://www.integralces.net/ces/interop/cenip"></td>
					</tr>
					<tr bgcolor="#DDDDDD">
					...
					<tr bgcolor="#EEEEEE">
						...
						<td class="text"><select name="time_offset" class="text" id="time_offset">
								...
								<option value="1" selected>GMT+1</option>
								<option value="2">GMT+2</option>
								<option value="3">GMT+3</option>
								<option value="4">GMT+4</option>
								<option value="5">GMT+5</option>
